 ...
 */
 ...
 class BitmapFontWriter {
	 ...
	 * 
	 * The FontInfo parameter is useful for cleaner output; such as including a fontSize and font face name hint. However, it can be
	...
	public static void writeFont (BitmapFontData fontData, String[] pageRefs, FileHandle outFntFile, FontInfo info, int scaleW, int scaleH) {
		...
		buf.append(xmlOpen)
			...
			.append("\" fontSize=").append( quote(info.size) )
