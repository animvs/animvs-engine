...
public final class AnimvsFontController {
    private Array<AnimvsFontInfo> fontsInfo;
    ...
    public AnimvsFontController(AnimvsLanguageController languageController, String propertyName, String languageDir, Array<AnimvsFontInfo> fontsInfo, String additionalCharacters, String versionTag, int referenceWidth) {
    ...
    private void loadFonts(String abbreviation) {
        ...
        for (int i = 0; i < fontsInfo.size; i++) {
            // int size = (int) ( ((Gdx.graphics.getWidth() +
