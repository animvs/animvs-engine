...
public final class AnimvsFontController {
	...
	public AnimvsFontController(AnimvsLanguageController languageController,String propertyName, String languageDir, Array<AnimvsFontInfo> fontsInfo, String additionalCharacters, int referenceWidth) {
